...
export default function Header() {
  return (
    <>
      <div className="container mt-20 px-5 md:px-0">
        <div className="flex flex-wrap sm:flex-nowrap  justify-center gap-x-[30px]">
          <div className="w-[510px]">
            <div className="flex flex-col justify-start">
              <h1 className="H4Sans sm:H3Sans md:H1Sans ">Discover</h1>
              <h1 className="H4Sans sm:H3Sans md:H1Sans">digital art & </h1>
              <h1 className="H4Sans sm:H3Sans md:H1Sans">Collect NFTs</h1>
            </div>
            <p className="mt-5 mb-10 md:mb-0">
              NFT marketplace UI created with Anima for Figma. Collect, buy and
              sell art from more than 20k NFT artists.
            </p>
            <div className="hidden sm:block">
              <button className="flex justify-center gap-x-3 w-[224px] py-[19px] mt-8 bg-purple rounded-[20px]">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
              ...
              <div className="flex gap-x-[30px] mt-[30px] items-center">
                <div className="flex flex-col ">
                  <span className="H4">240+</span>
                  <span className=" font-BodySans text-xl">Total Sale</span>
                </div>
                <div className="flex flex-col">
                  <span className="H4">100k+</span>
                  <span className=" font-BodySans text-xl">Auctions</span>
                </div>
                <div className="flex flex-col">
                  <span className="H4">240k+ </span>
                  <span className=" font-BodySans text-xl">Artists</span>
                </div>
              </div>
            </div>
          </div>
          <div className=" pb-[22px] bg-grayText-300 rounded-3xl">
            <img src="./img/home/banner.png" className="w-auto" />
            <div className="pt-[22px] pl-5">
              <h1 className=" font-BodySans text-[22px]">Space Walking</h1>
              <div className="mt-3 flex items-center gap-x-3">
                <img src="./img/home/Avatar.png" className="w-6" />
                <p>Animakid</p>
              </div>
            </div>
          </div>
          <div className="sm:hidden">
            <button className="flex justify-center gap-x-3 w-full sm:w-[224px] py-[19px] mt-8 bg-purple rounded-[20px]">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
