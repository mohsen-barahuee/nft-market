...
export default function Timer() {
  ...
  return (
    <div>
      <div className="w-full h-[590px] sm:h-[630px] md:h-[860px] timer_gradient relative">
        <div className=" absolute bottom-15 w-full">
          <div className="flex flex-wrap   justify-around items-start">
            <div>
              <div className="flex items-center gap-x-3 bg-grayText-300 px-5 py-2.5 rounded-full  w-48">
                <img src="./img/timer/profile.png" alt="" />
                <span className=" font-BodySans">Shroomie</span>
              </div>
              <div className="py-8.5 ">
                <h1 className="H3Sans md:H2Sans">Magic Mashrooms</h1>
              </div>
              <div>
                <button className=" hidden sm:flex gap-x-3 items-center font-BodySansBold bg-white text-black py-5 px-13 rounded-3xl ">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
            ...
            <div className="timer_bg  px-10 py-10 rounded-3xl">
              <div>
                <span className="caption">Auction ends in:</span>
              </div>
            ...
            <button className="flex mt-8.5 justify-center sm:hidden gap-x-3 items-center font-BodySansBold bg-white text-black py-5 px-27 rounded-3xl ">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
