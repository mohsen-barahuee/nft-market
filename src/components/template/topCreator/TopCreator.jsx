  ...
  return (
    <div>
      <div className="container px-8.5">
        <div className="flex justify-between mb-10 md:mb-15 ">
          <div>
            <h1 className="H4Sans md:H3Sans mb-1">Top creators</h1>
        ...
        <div className="grid grid-cols-1 gap-x-16 sm:gap-x-24 md:gap-x-0 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div className=" mb-8.5 w-81 h-25 md:w-62 md:h-59 bg-grayText-300 rounded-3xl relative">
            <div className="flex items-center absolute left-3 top-3.25 md:left-5 md:top-4.5">
              <span className=" font-BodyMono text-grayText-200 bg-grayText-400 py-1 px-2.5 rounded-full">
                1
              </span>
            </div>
            <div className="flex flex-row gap-x-5 md:gap-x-0 items-center justify-center  md:flex-col md:items-center mt-5">
              <img
                src="./img/creatores/Artist.png"
                alt=""
                className="w-15 h-15 md:w-27 md:h-30"
              />
              <div className="flex items-start  flex-col gap-y-1 md:items-center md:mt-5">
                <h5 className="H5Sans">Keepitreal</h5>
                <div className="flex gap-x-2.5">
                  <p className=" font-BodySans text-grayText-200">
                    Total Sales:
                  </p>
                  <p className=" font-BodyMono">34.53 ETH</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className=" mb-8.5 w-81 h-25 md:w-62 md:h-59 bg-grayText-300 rounded-3xl relative">
            ...
            <div className="flex flex-row gap-x-5 md:gap-x-0 items-center justify-center  md:flex-col md:items-center mt-5">
              <img
                src="./img/creatores/Artist10.png"
                alt=""
                className="w-15 h-15 md:w-27 md:h-30"
              />
              <div className="flex items-start  flex-col gap-y-1 md:items-center md:mt-5">
          ...
          <div className=" mb-8.5 w-81 h-25 md:w-62 md:h-59 bg-grayText-300 rounded-3xl relative">
            ...
            <div className="flex flex-row gap-x-5 md:gap-x-0 items-center justify-center  md:flex-col md:items-center mt-5">
              <img
                src="./img/creatores/Artist11.png"
                alt=""
                className="w-15 h-15 md:w-27 md:h-30"
              />
              <div className="flex items-start  flex-col gap-y-1 md:items-center md:mt-5">
          ...
          <div className=" mb-8.5 w-81 h-25 md:w-62 md:h-59 bg-grayText-300 rounded-3xl relative">
            ...
            <div className="flex flex-row gap-x-5 md:gap-x-0 items-center justify-center  md:flex-col md:items-center mt-5">
              <img
                src="./img/creatores/Artist12.png"
                alt=""
                className="w-15 h-15 md:w-27 md:h-30"
              />
              <div className="flex items-start  flex-col gap-y-1 md:items-center md:mt-5">
          ...
          <Link
            href="/ranking"
            className="flex sm:hidden gap-x-3 w-full py-[19px] mb-10  rounded-3xl items-center whitespace-nowrap justify-center font-BodySansBold border-2 border-purple"
          >
            <svg
              width="20"
              height="20"
